  ...
  return (
    <section className="max-w-[760px] mx-auto px-5 md:px-8 pt-10 pb-16">
      <TextFade direction="up">
        <h1 className="font-mondwest text-[#2c2c2c] text-[34px] md:text-[48px] mb-6">
          History
        </h1>
      </TextFade>
      ...
      {!supabaseEnabled ? (
        ...
        <p className="text-[15px] text-[#646464]">
          No attempts yet. Finish a quiz and it’ll show up here.
        </p>
      ) : (
        <div className="border-2 border-[#dee2de] rounded-2xl overflow-hidden">
          {attempts.map((a, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-right shrink-0 ml-4">
                  <p className="text-[18px] font-mondwest text-[#2c2c2c]">
                    {a.score}/{a.total}
                  </p>
                  <p
                    className={`text-[12px] ${
